...
public class ModelArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public Object resolveArgument(
        ...
        try {
            ...
            throw new IllegalStateException(
                    methodParameter.getType() + " Constructor access failed", e);
    ...
    private Object resolveArgumentInternal(
            MethodParameter methodParameter,
            HttpServletRequest request,
            HttpServletResponse response)
    ...
    private void populateArgument(
            Object target, Class<?> clazz, Field field, HttpServletRequest request)
        ...
        if (ReflectionUtils.hasFieldMethod(clazz, setterMethod, field.getType())) {
            ...
            method.invoke(
                    target,
                    ReflectionUtils.convertStringValue(
                            request.getParameter(field.getName()), field.getType()));
        }
    }
