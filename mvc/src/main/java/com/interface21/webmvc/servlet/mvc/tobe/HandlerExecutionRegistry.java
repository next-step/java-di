...
public class HandlerExecutionRegistry {
    ...
    private static final Logger log = LoggerFactory.getLogger(HandlerExecutionRegistry.class);
    ...
    public static Map<HandlerKey, HandlerExecution> createHandlerExecution(final BeanFactory beanFactory) {
        final var controllers = beanFactory.getControllers();
        final var handlers = new HashMap<HandlerKey, HandlerExecution>();

        controllers.forEach((controller, value) -> {
    ...
    private static Map<HandlerKey, HandlerExecution> createHandlerExecutions(final Object target, final Method method, final RequestMapping requestMapping) {
