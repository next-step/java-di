...
class AnnotationBasedConfiguration : FreeSpec({
    ...
    """ - {
        ...
        """ {
            ...
            kakaotalkMessageSender.shouldBeInstanceOf<MessageSender>()
        }
    ...
    """ {
        ...
        val firstMovieCatalog = applicationContext.getBean("firstMovieCatalog", movieCatalog::class.java)

        movieCatalog.shouldBeTypeOf<MovieCatalog>()
        movieCatalog.shouldBe(firstMovieCatalog)
    }
    ...
    """ {
        ...
        val secondMovieCatalog = applicationContext.getBean("secondMovieCatalog", MovieCatalog::class.java)
        val secondMovieCatalog2 = applicationContext.getBean("secondMovieCatalog2", MovieCatalog::class.java)

        movieCatalog.shouldBeTypeOf<MovieCatalog>()

        // Resource 와 Qualifier 를 동시에 지정하면 Resource 가 우선하지만 이러지 말자
        movieCatalog.shouldBe(secondMovieCatalog)
    }
