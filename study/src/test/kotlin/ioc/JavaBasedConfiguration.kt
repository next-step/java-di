...
class JavaBasedConfiguration : FreeSpec({
    ...
    """ - {
        ...
        """ {
            ...
            val secondAnotherViewResolver2 = fullModeConfig.anotherViewResolver()

            firstAnotherViewResolver shouldBe secondAnotherViewResolver
            secondAnotherViewResolver shouldBe secondAnotherViewResolver2
        }
