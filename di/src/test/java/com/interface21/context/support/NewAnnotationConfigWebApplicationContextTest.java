...
class NewAnnotationConfigWebApplicationContextTest {
    @Test
    @DisplayName("특정 패키지 밑의 bean 클래스를 클래스 타입으로 받환 받을 수 있다.")
    void getBeanTest() {
        final ApplicationContext applicationContext = new NewAnnotationConfigWebApplicationContext(MyConfiguration.class);
