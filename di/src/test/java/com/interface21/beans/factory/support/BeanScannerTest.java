...
class BeanScannerTest {
    ...
    void registerBeans() {
        assertAll(
            () -> assertThat(beanFactory.getBean(JdbcSampleRepository.class)).isInstanceOf(
                JdbcSampleRepository.class),
            () -> assertThat(
                JdbcSampleRepository.class.isAnnotationPresent(Repository.class)).isTrue(),
            () -> assertThat(beanFactory.getBean(SampleController.class)).isInstanceOf(
                SampleController.class),
            () -> assertThat(SampleController.class.isAnnotationPresent(Controller.class)).isTrue(),
            () -> assertThat(beanFactory.getBean(SampleService.class)).isInstanceOf(
                SampleService.class),
