...
class MethodInjectorTest {
    ...
    class Inject {
        ...
        void inject() {
            ...
            final var methodInjector = new MethodInjector();
            ...
            // when
            final var sampleMethodService = (SampleMethodService) methodInjector.inject(new GenericBeanDefinition(SampleMethodService.class), beanFactory);
