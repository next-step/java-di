...
public class BeanFactoryUtils {
    ...
    @SuppressWarnings({"unchecked"})
    public static Set<Method> getBeanMethods(
    ...
    public static Set<Constructor> getInjectedConstructors(Class<?> clazz) {
        return ReflectionUtils.getAllConstructors(
                clazz, ReflectionUtils.withAnnotation(Autowired.class));
    }
    ...
    public static Constructor<?> getInjectedConstructor(Class<?> clazz) {
        Set<Constructor> injectedConstructors =
                ReflectionUtils.getAllConstructors(
                        clazz, ReflectionUtils.withAnnotation(Autowired.class));
     ...
     * @return
     */
    public static Optional<Class<?>> findConcreteClass(
            Class<?> injectedClazz, Set<Class<?>> preInstanticateBeans) {
