...
public class BeanFactoryUtils {
    ...
    public static String[] getBasePackages(Class<?>... configurationClasses) {
        return Arrays.stream(configurationClasses)
            .map(BeanFactoryUtils::getBasePackages)
            .flatMap(List::stream)
            .distinct()
            .toArray(String[]::new);
    }

    private static List<String> getBasePackages(Class<?> configurationClass) {
